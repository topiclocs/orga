...
Use the file-creator subagent to create the file: product/mission.md and use the following template:
...
Use the file-creator subagent to create the file: product/tech-stack.md and use the following template:
